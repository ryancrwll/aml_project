...
DATA_FILE = './data/indoor_flying2_data.hdf5'  # 1.6GB - VERY SLOW, use flying4 instead
# DATA_FILE = './data/indoor_flying4_data.hdf5'  # 671MB - FAST, recommended for testing
GT_FILE = './data/indoor_flying2_gt.hdf5'  # 3.2GB - VERY SLOW
...
def evaluate_model():
    ...
    if pred_deltas is None:
        # No checkpoints found — run inference and save chunks
